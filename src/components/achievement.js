        ...
        <div className="bg-white" id="achievement">
            <div className="mx-auto max-w-screen-xl max-h-full py-18 pb-16 px-8 pt-20">
                <div className="text-center mb-10">
                    <h1 className="text-4xl text-blue-700 font-medium mb-5">Achievement</h1>
                    ...
                    <div>
                        <div className="mt-5 md:grid md:grid-cols-2 items-center">
                            <div className="md:col-span-1 px-1 py-1 md:px-2 md:py-2"><Image src={TGR1} className="rounded-md" alt="TGR2024"></Image></div>
                            <div className="md:col-span-1 px-1 py-1 md:px-2 md:py-2"><Image src={TGR2} className="rounded-md" alt="TGR2024"></Image></div>
                            <div className="md:col-span-1 px-1 py-1 md:px-2 md:py-2"><Image src={TGR3} className="rounded-md" alt="TGR2024"></Image></div>
                            <div className="md:col-span-1 px-1 py-1 md:px-2 md:py-2"><Image src={TGR4} className="rounded-md" alt="TGR2024"></Image></div>
